...
export default function Intro() {
    ...
    return (
        <div className={`w-full h-auto p-0 relative top-[50px] mb-[100px]`}>
            <div className={`w-full flex  flex-wrap-reverse pt-10`}>
                ...
                <div className={`w-full h-auto relative top-[20px] p-[10px] mb-[30px] md:mb-0 md:w-[45%]`}>
                    ...
                    <div className={`relative top-[20px]`}>
                        ...
                        {usersInfo.greeting_type} {/* {usersInfo.greeting_type}  I'm {usersInfo.full_name}. */}What I Do
                        </h1>
                        <br />
                        <br />
        ...
        <>
            {
                data.length > 0 ?
                    data.map((skill, i) => {
                        return (
                            <div data-aos="zoom-in-up" key={i} className={`w-full p-[20px] rounded-[5px] bg-dark-400 m-[0px] relative transition-all mt-4 hover:shadow-2xl `}>
                                ...
                                <div className={` bottom-[10px] pt-[5px]`}>
