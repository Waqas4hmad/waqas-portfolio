...
export default function Header({ children }) {
    ...
    return (
        <header className={`header w-full h-[750px] relative bg-dark-200 md:h-auto pt-[40px]`}>
            <Container>
                {children}

                {/* shows on desktop */}
                <div className={`w-full h-[70vmin] flex align-center items-center justify-center flex-row p-[20px] flex-wrap mt-[25px]`}>
                    ...
                    <div className={`w-full h-auto  relative md:w-[50%]`}>
                        ...
                        <div className={`relative top-[0px] flex align-start items-start justify-start w-full`}>
                    ...
                    <div data-aos="fade-left" className={`main w-full h-full hidden md:flx md:w-[50%] relative`}>
                        <div className={`img-cont w-[250px] h-[250px] p-[15vmin] flex flex-col bg-cover bg-center  rounded-[50%]  `}>
                            <style jsx>{`
                                .img-cont{
